...
class Music {
  ...
  static async getUserPlaylist(userID, redisClient) {
    ...
    let userPlaylist = await hgetAsync(`user: ${userID}`, 'userPlaylist');
  ...
  */
  ...
  /**
   * Try to find a song in a message.
   * @param {string} singleArgument Argument specified by the user.
   * @param {Message} msg Discord message
   * @param {object} asyncRedis Redis async methods
   * @param {string} ytAPI Youtube v3 api
   */
