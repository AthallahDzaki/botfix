...
Source Code from Grace.js
Have a great day :3 From ANGGA#7019`];
...
exports.inv = ["`\`\`\`https://discordapp.com/api/oauth2/authorize?client_id=508115155536707611&permissions=0&scope=bot`\`\`\`"];
exports.gifs = {
  hug: [
